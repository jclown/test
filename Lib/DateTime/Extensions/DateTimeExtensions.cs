...
namespace System
{
    ...
    public static class DateTimeExtensions
    {
        ...
        public static TimeSpan GetTodayRemain(this DateTime target)
        {
            return target.Date.AddDays(1).AddMilliseconds(-1) - DateTime.Now;
        }
        ...
        /// <summary>
        /// 日期转换为时间戳（时间戳单位秒） 世界时 (UTC) 
        /// </summary>
        /// <param name="TimeStamp"></param>
        /// <returns></returns>
        public static long ConvertToTimeStampUtc(this DateTime time)
        {
        ...
        /// <summary>
        /// 时间戳转换为日期（时间戳单位秒） 世界时 (UTC) 
        /// </summary>
        /// <param name="TimeStamp"></param>
        /// <returns></returns>
        public static DateTime ConvertToDateTimeUtc(this long timeStamp)
        {
        ...
        /// <summary>
        /// 字符串转换为日期（时间戳单位秒） 世界时 (UTC) 
        /// </summary>
        /// <param name="TimeStamp"></param>
        /// <returns></returns>
        public static DateTime ConvertToDateTimeUtc(this string time)
        {
        ...
        /// <summary>
        /// 日期转换为时间戳（时间戳单位秒） 世界时 (Local) 
        /// </summary>
        /// <param name="TimeStamp"></param>
        /// <returns></returns>
        public static long ConvertToTimeStampLocal(this DateTime time)
        {
        ...
        /// <summary>
        /// 时间戳转换为日期（时间戳单位秒） 世界时 (Local) 
        /// </summary>
        /// <param name="TimeStamp"></param>
        /// <returns></returns>
        public static DateTime ConvertToDateTimeLocal(this long timeStamp)
        {
        ...
        /// <summary>
        /// 字符串转换为日期（时间戳单位秒） 世界时 (Local) 
        /// </summary>
        /// <param name="TimeStamp"></param>
        /// <returns></returns>
        public static DateTime ConvertToDateTimeLocal(this string time)
        {
