...
namespace Lib
{
    public class DES
    {
        ...
        public string EncryptDES(string beinetstr, string beinetkey)
        {
            ...
            catch (Exception ex) { throw new Exception("加密失败，请检查程序前后端是否均已启用加密。", ex); }
        }
        ...
        public string DecryptDES(string beinetstr, string beinetkey)
        {
            ...
            catch (Exception ex) { throw new Exception("解密失败，请检查程序前后端是否均已启用加密。", ex); }
        }
