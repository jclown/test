    ...
    public static class Copier<TSource, TTarget>
    {
        ...
        public static TTarget Copy(TSource source)
        {
            ...
            else
            {
                ...
                {
                    // 从源对象获取同名的属性信息
                    var sourcePropInfo = sourceType.GetProperty(targetPropInfo.Name,BindingFlags.IgnoreCase);
        ...
        public static void Copy(TSource source, TTarget target)
        {
            ...
            else
            {
                ...
                {
                    // 从源对象获取同名的属性信息
                    var sourcePropInfo = sourceType.GetProperty(targetPropInfo.Name, BindingFlags.Public | BindingFlags.Instance | BindingFlags.IgnoreCase);
                    ...
                    // 3.目标属性可写
                    // 4.排除特定字段
                    bool isExclude = (targetPropInfo.Name == "CreateTime") || (targetPropInfo.Name == "UpdateTime");
        ...
        public static MethodInfo GetCopyMethodInfo(Type source, Type target)
